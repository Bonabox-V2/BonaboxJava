...
public class StatusEntrega {
	...
	public StatusEntrega(String entregaId, Integer statusEntregaId, Integer situacaoId, Integer codigoEntregador,
			LocalDateTime dataHora, Integer codigoAla, Integer codigoBloco, Integer codigoUnidade,
			Integer codigoNumeroPortaBox, String nomeMorador) {
		super();
