...
public class CompartimentoStatusTempResponse {
	...
	public CompartimentoStatusTempResponse() {

	}

	public CompartimentoStatusTempResponse(String compartimentoIdAleatorio, int compartimentoId, int boxId,
