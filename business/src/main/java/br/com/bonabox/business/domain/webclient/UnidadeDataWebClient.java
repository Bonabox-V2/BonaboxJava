...
public class UnidadeDataWebClient {
	...
	public UnidadeDataWebClient() {
		
	}
	
	public UnidadeDataWebClient(Integer unidadeId, Integer piso, Integer numeroUnidade, String labelUnidade) {
		super();
