...
public class StatusEntregaDataWebClient {
	...
	public StatusEntregaDataWebClient() {
	}

	public StatusEntregaDataWebClient(String entregaId, Integer statusEntregaId, Integer situacaoId,
			Integer codigoEntregador, LocalDateTime dataHora, Integer codigoAla, Integer codigoBloco,
			Integer codigoUnidade, Integer codigoNumeroPortaBox, String nomeMorador) {
		super();
